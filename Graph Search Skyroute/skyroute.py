...
def set_start_and_end(start_point, end_point):
  if start_point != None:
    change_point = input("What would you like to change? you can enter 'o' for 'origin', 'd' for 'desination', or 'b' for 'both': ")
    if change_point == 'b':
...
#for active_station, connecting_stations in active_stations.items():
#  print(active_station, '-', str(connecting_stations))
